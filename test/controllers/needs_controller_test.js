...
exports['needs controller'] = {
  ...
  'POST create ignore satisfaction & createdAt & updatedAt': function (test) {
    var need = new ValidAttributes;
    need.satisfaction = 1
    need.createdAt = need.updatedAt = new Date('5555-11-03 11:42:11')
    var create = Need.create;
    Need.create = sinon.spy(function (data, callback) {
      test.equal(data.satisfaction, null)
